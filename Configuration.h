...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160.55,160.06,6545.5,370}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {1000, 1000, 5, 500}    // (mm/sec){1000, 1000, 10, 500}
